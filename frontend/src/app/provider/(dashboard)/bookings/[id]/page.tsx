...
export default function ProviderBookingDetailPage() {
  ...
  async function handleMarkNoShow() {
    if (!confirm('Mark this booking as no-show? This action cannot be undone.')) {
      return;
    }
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              {canConfirm && (
                <Button onClick={handleConfirmBooking} className="w-full gap-2">
              ...
              {canMarkNoShow && (
                <Button onClick={handleMarkNoShow} variant="destructive" className="w-full gap-2">
